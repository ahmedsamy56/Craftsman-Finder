...
namespace CraftsmanFinder.Web.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        {
            if (!_roleManager.RoleExistsAsync(SD.CraftsmenRole).GetAwaiter().GetResult())
            {
                _roleManager.CreateAsync(new IdentityRole(SD.AdminRole)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(SD.HomeOwnerRole)).GetAwaiter().GetResult();
                _roleManager.CreateAsync(new IdentityRole(SD.CraftsmenRole)).GetAwaiter().GetResult();
            }
            ReturnUrl = returnUrl;
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                {
                    var file = Request.Form.Files["profile_image"];
                    if (file != null && file.Length > 0)
                    {
                        // Define a path relative to wwwroot
                        ...
                        user.ProfileImagePath = "/uploads/profile/" + uniqueFileName;
                    }
                }
                ...
                if (result.Succeeded)
                {
                    ...
                    var selectedRole = Request.Form["role"];
